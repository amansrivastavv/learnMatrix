          ...
          <Card className="border-border/50 shadow-xl backdrop-blur-sm bg-card/80">
            <CardContent className="pt-6 text-center space-y-4">
              <div className="relative inline-block">
                ...
                <div
                  className="absolute bottom-2 right-2 h-6 w-6 rounded-full bg-green-500 border-4 border-background"
                  title="Online"
                />
              </div>
              ...
              <div className="pt-4 space-y-3 text-sm text-left">
                ...
                <div className="flex justify-center gap-4 pt-4">
                  ...
                  <Button
                    variant="ghost"
                    size="icon"
                    className="hover:text-white hover:bg-black/10 dark:hover:bg-white/10"
                  >
